...
<cfset set(datasourceName="vinbal")>
...
--->
	...
	<cfset set(FunctionName="textField", labelPlacement="before", appendTolabel="<BR>", append="<BR>")>
	<cfset set(functionName="Select", labelPlacement="before", appendTolabel="<BR>", append="<BR>")>
	<cfset set(functionName="textDisplay", appendToLabel="TEST")>